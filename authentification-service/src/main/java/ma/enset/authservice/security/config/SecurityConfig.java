package ma.enset.authservice.security.config;
...
import ma.enset.authservice.security.handlers.CustomAccessDeniedHandler;
import ma.enset.authservice.security.handlers.CustomAuthenticationHandler;
